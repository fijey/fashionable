...
<div class="container">
    ...
    <section class="content mb-5">
        <form action="/managementuser/edit/{{ $u->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $u->name }}" placeholder="Nama "
                                    class="form-control">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" value="{{ $u->email }}" placeholder="Email"
                                    class="form-control">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" disabled id="inputName" name="password"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" disabled id="inputName" name="retype_password"
                                    value="{{ $u->password }}" class="form-control">
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="lazada" name="address" value="{{ $u->address }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="lazada" name="handphone" value="{{ $u->handphone }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="age" name="age" value="{{ $u->age }}" placeholder="umur"
                                    class="form-control">
                                @if ($errors->has('age'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="Kota" name="city" placeholder="Kota" value="{{ $u->city }}"
                                    class="form-control">
                                @if ($errors->has('city'))
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName" name="store_name" value="{{ $u->store_name }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="inputName" name="store_address"
                                    value="{{ $u->address }}" placeholder="Nama Produk"><br>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="inputName" name="store_about"
                                    value="{{ $u->store_about }}" placeholder="Nama Produk"><br>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" id="inputName" name="store_img"
                                    value="{{ old('store_img') }}" placeholder="Nama Produk"><br>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="inputName" name="store_lazada"
                                    value="{{ $u->store_img }}" placeholder="Nama Produk"><br>
