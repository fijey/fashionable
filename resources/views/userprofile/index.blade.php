            ...
            <div class="card-body box-profile">
              <div class="text-center">
                <img class="profile-user-img img-fluid img-circle"
                     src="{{ Auth::user()->profile->img_profile }}"
                     alt="User profile picture">
              </div> 
              <h3 class="profile-username text-center"><i class="fas fa-user mr-2"></i>{{ Auth::user()->name }}</h3>
              <p class="text-center"><i class="fas fa-store ml-1 mr-2"></i>{{ Auth::user()->profile->store->store_name }}</p>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <p class="text-muted">
                    <table>
                        <tr>
                            <td><a href="{{ Auth::user()->profile->store->store_lazada }}"><img class="logo-commerce img-fluid" src="/img/lazada.png"> </a> </td>
                            <td></td>
                            <td><span class="ml-3">Tersedia</span>  </td>
                        </tr>
                        <tr>
                            <td> <a class="float-center" href="{{ Auth::user()->profile->store->store_bukalapak }}"><img class="logo-commerce img-fluid" src="/img/bukalapak.png"> </a> </td>
                            <td></td>
                            <td><span class="ml-3">Tersedia</span>  </td>
                        </tr>
                        <tr>
                            <td> <a class="float-center" href="{{ Auth::user()->profile->store->store_tokopedia }}"><img class="logo-commerce img-fluid" src="/img/tokopedia.png"> </a> </td>
                            <td></td>
                            <td><span class="ml-3">Tersedia</span>  </td>
                        </tr>
                        <tr>
                            <td><a class="float-center" href="{{ Auth::user()->profile->store->store_shopee }}"><img class="logo-commerce img-fluid" src="/img/shopee.png"> </a> </td>
                            <td></td>
                            <td><span class="ml-3">Tersedia</span>  </td>
                        </tr>
                    </table>
                ...
                <div class="tab-pane" id="settings">
                  <form class="form-horizontal" method="POST" action="/editprofile" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="age" class="form-control" value="{{ Auth::user()->profile->age }}" id="inputEmail" placeholder="Age">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputName2" class="col-sm-2 col-form-label">city</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="city" value="{{ Auth::user()->profile->city }}" id="inputName2" placeholder="city">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputName2" class="col-sm-2 col-form-label">Handphone</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="handphone" value="{{ Auth::user()->profile->handphone }}" id="inputName2" placeholder="Handphone">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputExperience" class="col-sm-2 col-form-label">address</label>
                      <div class="col-sm-10">
                        <textarea class="form-control" name="address" id="inputExperience">{{ Auth::user()->profile->address }}</textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="tab-pane" id="mystore">
                  <form class="form-horizontal" method="POST" action="/editstore" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="store_name" value="{{ Auth::user()->profile->store->store_name }}" class="form-control" id="inputName" placeholder="Nama Toko">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail" class="col-sm-2 col-form-label">Alamat Toko</label>
                      <div class="col-sm-10">
                        <input type="text" name="store_address" value="{{ Auth::user()->profile->store->store_address }}" class="form-control" id="inputEmail" placeholder="alamat toko">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail" class="col-sm-2 col-form-label">URL Profile Lazada</label>
                      <div class="col-sm-10">
                        <input type="text" name="store_lazada" class="form-control" value="{{ Auth::user()->profile->store->store_lazada }}" id="inputEmail" placeholder="URL Profile Lazada">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail" class="col-sm-2 col-form-label">URL Profile Tokopedia</label>
                      <div class="col-sm-10">
                        <input type="text" name="store_tokopedia" class="form-control" value="{{ Auth::user()->profile->store->store_tokopedia }}" id="inputEmail" placeholder="URL Profile Tokopedia">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail" class="col-sm-2 col-form-label">URL Profile Shopee</label>
                      <div class="col-sm-10">
                        <input type="text" name="store_shopee" class="form-control" value="{{ Auth::user()->profile->store->store_shopee }}" id="inputEmail" placeholder="URL Profile Shopee">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail" class="col-sm-2 col-form-label">URL Profile Bukalapak</label>
                      <div class="col-sm-10">
                        <input type="text" name="store_bukalapak" class="form-control" value="{{ Auth::user()->profile->store->store_bukalapak }}" id="inputEmail" placeholder="URL Profile bukalapak">
                      </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Tentang Toko</label>
                        <div class="col-sm-10">
                          <input type="text" name="store_about" class="form-control" value="{{ Auth::user()->profile->store->store_about }}" id="inputEmail" placeholder="Tentang Toko">
                        </div>
                      </div>
