...
<!-- Content Wrapper. Contains page content -->
    ...
    <section class="content mb-5">
      <form action="/editproduct/{{ $pu->id_product }}" method="post" enctype="multipart/form-data">
        @csrf
      <div class="row">
        <div class="col-md-6">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control select2"  name="id_category" style="width: 100%;">
                      ...
                      <option value="{{ $ct->id_category }}" @if($pu->id_category==$ct->id_category) @php echo 'selected="selected"'; @endphp @endif>{{ $ct->category_name }}</option>    
                      @endforeach
                    </select>
                  </div>
              <div class="form-group">
                <label for="inputName">Nama Produk</label> <br>
                <input type="text" id="inputName" name="product_name" value="{{ $pu->product_name }}" placeholder="Nama Produk" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" id="inputName" name="product_brand" value="{{ $pu->product_brand }}" placeholder="Nama Produk" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" id="inputName" name="product_condition" placeholder="Nama Produk" value="{{ $pu->product_condition }}" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="number" id="inputName" name="product_price"  placeholder="15000" value="{{ $pu->product_price }}" class="form-control uang">
              ...
              <div class="form-group">
                ...
                <textarea id="inputDescription" name="product_description" placeholder="Masukan Deskripsi" class="form-control" rows="4">{{ $pu->product_description }}</textarea>
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="lazada" name="product_lazada" value="{{ $pu->product_lazada }}" placeholder="lazada" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" id="lazada" name="product_tokopedia" value="{{ $pu->product_tokopedia }}" placeholder="tokopedia" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" id="lazada" name="product_shopee" placeholder="shopee" value="{{ $pu->product_shopee }}" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" id="lazada" name="product_bukalapak" placeholder="bukalapak" value="{{ $pu->product_bukalapak }}" class="form-control">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Edit Produk" class="btn btn-success float-right">
        </div>
      </div>
    </form>
    </section>
