...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('/landingpageassets/favicon.ico')}}" type="image/png">
    <!-- Fonts -->
        ...
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header  align-items-center">
                <a class="navbar-brand" href="javascript:void(0)">
                    <img src="{{asset('/landingpageassets/logo.png')}}" class="navbar-brand-img" alt="...">
                </a>
            </div>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/discussion">
                                ...
                                <span class="nav-link-text">Discussions</span>
                            </a>
                        </li>
